...
# modified 2025 Werner Krenn:  log and summary_heading (as version 3)
#
...
class MyXSearch(SearchList):
    ...
    def _statsDict(self, table_key, data_table, table_options, table_stats, binding):
        ...
        summary_heading = 'Year'
        if table_options.get("summary_heading") != None:
          summary_heading = table_options.get("summary_heading")
        data_table["summary_heading"] = summary_heading
