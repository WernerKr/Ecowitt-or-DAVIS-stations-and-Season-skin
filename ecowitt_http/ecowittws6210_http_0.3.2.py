...
Version: 0.3.2                                  Date: 22 Mar 2026
...
class DirectEcowittDevice:
    ...
    known_fields = ['rain.0x0D.val', 'rain.0x0D.voltage',
                    ...
                    'wqt01.battery', 'wqt01.signal', 'wqt01.rssi',
                    ]
    ...
    def display_service_field_map(self):
        ...
        if WxVersion4.erg == True:
          use_service = 'user.ecowittws6210_http.EcowittHttpService'
        else:
          use_service = 'ecowittws6210_http.EcowittHttpService'
...
#       $ python3 -m user.ecowittws6210_http
#   for git installs use:
#       $ source ~/weewx-venv/bin/activate
#       $ PYTHONPATH=~/weewx/src:~/weewx-data/bin python3 -m user.ecowittws6210_http
...
def main():
    ...
    weeutil.logger.setup('ecowittws6210_http', config_dict)
